...
%Calibration of Kd for Potassium using their Potassium predicted values for 
%no geomembrane.
...
Kd0 = 7; %linear partitioning coefficient (mL/g)
...
cali = 0.1:0.05:2; %changing the value of Kd by these ratios
